...
/***********************测量数据存储****************************/
  data_8bit = REG_CorrectionV >> 24;
	...
	EEPROM_WriteByte(0x60, data_8bit);
	data_8bit = REG_CorrectionR1 >> 8;
	EEPROM_WriteByte(0x61, data_8bit);
	EEPROM_WriteByte(0x62, REG_CorrectionR1);//内阻低档
	...
	EEPROM_WriteByte(0x66, REG_ReadR1_Offset);//内阻低档
...
/****************电子负载*********************/
	...
	/*****************内阻低档********************************/
	REG_CorrectionR1=EEPROM_READ_Byte(0x5F);
	REG_CorrectionR1=REG_CorrectionR1<<8;
	REG_CorrectionR1=REG_CorrectionR1+EEPROM_READ_Byte(0x60);
	REG_CorrectionR1=REG_CorrectionR1<<8;
	REG_CorrectionR1=REG_CorrectionR1+EEPROM_READ_Byte(0x61);
	REG_CorrectionR1=REG_CorrectionR1<<8;
	REG_CorrectionR1=REG_CorrectionR1+EEPROM_READ_Byte(0x62);
	
	REG_ReadR1_Offset=EEPROM_READ_Byte(0x63);
	REG_ReadR1_Offset=REG_ReadR1_Offset<<8;
	REG_ReadR1_Offset=REG_ReadR1_Offset+EEPROM_READ_Byte(0x64);
	REG_ReadR1_Offset=REG_ReadR1_Offset<<8;
	REG_ReadR1_Offset=REG_ReadR1_Offset+EEPROM_READ_Byte(0x65);
	REG_ReadR1_Offset=REG_ReadR1_Offset<<8;
	REG_ReadR1_Offset=REG_ReadR1_Offset+EEPROM_READ_Byte(0x66);
